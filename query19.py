...
if __name__ == "__main__":
    ...
    if all_vulnerabilities and all_tags_map:
        ...
        httpd_vulns = [v for v in all_vulnerabilities if v.get('project_name', '').lower() == 'struts']
        print(f"\n[FILTRO] {len(httpd_vulns)} vulnerabilidades do struts de {len(all_vulnerabilities)} totais")
